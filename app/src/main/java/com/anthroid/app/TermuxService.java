...
import com.anthroid.app.event.SystemEventReceiver;
import com.anthroid.app.terminal.TermuxTerminalSessionActivityClient;
import com.anthroid.app.terminal.TermuxTerminalSessionServiceClient;
import com.anthroid.shared.termux.plugins.TermuxPluginUtils;
import com.anthroid.shared.data.IntentUtils;
import com.anthroid.shared.net.uri.UriUtils;
import com.anthroid.shared.errors.Errno;
import com.anthroid.shared.shell.ShellUtils;
import com.anthroid.shared.shell.command.runner.app.AppShell;
import com.anthroid.shared.termux.settings.properties.TermuxAppSharedProperties;
import com.anthroid.shared.termux.shell.command.environment.TermuxShellEnvironment;
import com.anthroid.shared.termux.shell.TermuxShellUtils;
...
import com.anthroid.shared.notification.NotificationUtils;
import com.anthroid.shared.android.PermissionUtils;
import com.anthroid.shared.data.DataUtils;
...
import com.anthroid.shared.shell.command.ExecutionCommand.ShellCreateMode;
import com.anthroid.terminal.TerminalEmulator;
...
public final class TermuxService extends Service implements AppShell.AppShellClient, TermuxSession.TermuxSessionClient {
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.anthroid.shared.R.string.error_execution_cancelled))) {
    ...
    private Notification buildNotification() {
        ...
        // Set notification icon (Termux terminal uses >_ icon)
        builder.setSmallIcon(R.drawable.ic_termux_notification);
