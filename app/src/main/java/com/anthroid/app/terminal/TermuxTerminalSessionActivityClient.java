...
import com.anthroid.shared.termux.terminal.io.BellHandler;
import com.anthroid.shared.logger.Logger;
import com.anthroid.terminal.TerminalColors;
import com.anthroid.terminal.TerminalSession;
import com.anthroid.terminal.TerminalSessionClient;
import com.anthroid.terminal.TextStyle;
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                ...
                // Catch java.lang.RuntimeException: Unable to resume activity {com.anthroid/com.anthroid.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
