...
import { i as pruneDiagnosticSessionStates, r as getDiagnosticSessionState, t as diagnosticSessionStates } from "./diagnostic-session-state-Dd5FXtMe.mjs";

//#region D:/user/work/openclaw/src/infra/diagnostic-events.ts
...
//#endregion
//#region D:/user/work/openclaw/src/logging/diagnostic.ts
...
function startDiagnosticHeartbeat() {
	...
	heartbeatInterval = setInterval(() => {
		...
		import("./command-poll-backoff-DP-hMAFy.mjs").then((n) => n.t).then(({ pruneStaleCommandPolls }) => {
