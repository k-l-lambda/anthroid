import { B as isNotFoundPathError, H as isSymlinkOpenError, I as sameFileIdentity, V as isPathInside } from "./agent-scope-Br-sgzCy.mjs";
import { n as assertNoPathAliasEscape } from "./path-alias-guards-D3nAPD9G.mjs";
import fs from "node:fs/promises";
import { constants } from "node:fs";
import path from "node:path";

//#region D:/user/work/openclaw/src/infra/fs-safe.ts
