...
import { tt as shouldLogVerbose } from "./runtime-BX7HNrbF.mjs";
import { d as sanitizeAgentId, f as DEFAULT_ACCOUNT_ID, i as buildAgentPeerSessionKey, n as DEFAULT_MAIN_KEY, p as normalizeAccountId, r as buildAgentMainSessionKey, s as normalizeAgentId, t as DEFAULT_AGENT_ID } from "./session-key-CemdY1ss.mjs";
import { t as normalizeChatType } from "./chat-type-IDrLD0yN.mjs";
import { c as resolveDefaultAgentId, k as logDebug } from "./agent-scope-Br-sgzCy.mjs";
import { n as listBindings } from "./bindings-DmfwnNeP.mjs";

//#region D:/user/work/openclaw/src/routing/resolve-route.ts
