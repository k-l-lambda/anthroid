import { s as resolveStateDir, u as resolveRequiredHomeDir } from "./paths-DgyWxrss.mjs";
import { $ as logVerboseConsole, R as pathExists$1, V as resolveUserPath, X as danger, Z as info, ct as getLogger, g as defaultRuntime, m as createSubsystemLogger, rt as warn, tt as shouldLogVerbose } from "./runtime-BX7HNrbF.mjs";
import { b as isSubagentSessionKey, l as resolveAgentIdFromSessionKey, s as normalizeAgentId, t as DEFAULT_AGENT_ID, x as parseAgentSessionKey, y as isCronSessionKey } from "./session-key-CemdY1ss.mjs";
...
//#region D:/user/work/openclaw/src/config/model-input.ts
...
//#endregion
//#region D:/user/work/openclaw/src/agents/skills/filter.ts
...
//#endregion
//#region D:/user/work/openclaw/src/infra/path-guards.ts
...
//#endregion
//#region D:/user/work/openclaw/src/infra/boundary-path.ts
...
async function resolveBoundaryPathLexicalAsync(params) {
	const segments = path.relative(params.rootPath, params.absolutePath).split(path.sep).filter(Boolean);
	...
	for (let idx = 0; idx < segments.length; idx += 1) {
		...
		if (!isPathInside(params.rootCanonicalPath, linkCanonical)) throw symlinkEscapeError({
			boundaryLabel: params.params.boundaryLabel,
			rootCanonicalPath: params.rootCanonicalPath,
...
//#endregion
//#region D:/user/work/openclaw/src/infra/file-identity.ts
...
//#endregion
//#region D:/user/work/openclaw/src/infra/safe-open-sync.ts
...
function openVerifiedFileSync(params) {
	...
	try {
		...
		if (params.rejectHardlinks && openedStat.nlink > 1) return {
			ok: false,
			reason: "validation"
		};
...
//#endregion
//#region D:/user/work/openclaw/src/infra/boundary-file-read.ts
...
//#endregion
//#region D:/user/work/openclaw/src/logger.ts
...
//#endregion
//#region D:/user/work/openclaw/src/process/spawn-utils.ts
...
//#endregion
//#region D:/user/work/openclaw/src/process/exec.ts
...
//#endregion
//#region D:/user/work/openclaw/src/infra/openclaw-root.ts
...
//#endregion
//#region D:/user/work/openclaw/src/agents/workspace-templates.ts
...
//#endregion
//#region D:/user/work/openclaw/src/agents/workspace.ts
...
//#endregion
//#region D:/user/work/openclaw/src/agents/agent-scope.ts
