import { c as expandHomePrefix, s as resolveStateDir, u as resolveRequiredHomeDir } from "./paths-DgyWxrss.mjs";
import { s as normalizeAgentId, t as DEFAULT_AGENT_ID } from "./session-key-CemdY1ss.mjs";
import os from "node:os";
import fs from "node:fs";
import path from "node:path";

//#region D:/user/work/openclaw/src/config/sessions/paths.ts
