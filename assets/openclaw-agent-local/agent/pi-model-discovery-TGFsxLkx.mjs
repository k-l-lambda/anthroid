...
import { $t as normalizeProviderId, Bt as ensureAuthProfileStore } from "./model-auth-13_YNSQX.mjs";
import * as PiCodingAgent from "@mariozechner/pi-coding-agent";
import fs from "node:fs";
import path from "node:path";

//#region D:/user/work/openclaw/src/agents/pi-auth-credentials.ts
...
//#endregion
//#region D:/user/work/openclaw/src/agents/pi-model-discovery.ts
