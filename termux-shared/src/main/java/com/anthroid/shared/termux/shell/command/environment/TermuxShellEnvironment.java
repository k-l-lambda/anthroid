package com.anthroid.shared.termux.shell.command.environment;
...
import com.anthroid.shared.shell.command.environment.AndroidShellEnvironment;
import com.anthroid.shared.shell.command.environment.ShellEnvironmentUtils;
import com.anthroid.shared.shell.command.environment.ShellCommandShellEnvironment;
    ...
    public HashMap<String, String> getEnvironment(@NonNull Context currentPackageContext, boolean isFailSafe) {
        ...
        if (!isFailSafe) {
            ...
            if (TermuxBootstrap.isAppPackageVariantAPTAndroid5()) {
                ...
                // Set LD_LIBRARY_PATH to override hardcoded RUNPATH in binaries
                // This is needed because bootstrap binaries have com.termux paths baked in
