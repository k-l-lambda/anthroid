package com.anthroid.shared.activities;
 ...
 * {@code `<activity android:name="com.anthroid.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.anthroid.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
